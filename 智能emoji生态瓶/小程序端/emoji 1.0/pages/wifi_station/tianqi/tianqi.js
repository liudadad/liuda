...
var lineChart_water = null
var lineChart_gas = null
var app = getApp()
...
Page({
  ...
  convert: function () {
    ...
    for (var i = 0; i < length; i++) {
      ...
      water.push(app.globalData.temperature.datapoints[i].value);
      gas.push(app.globalData.light.datapoints[i].value);
    }
    return {
